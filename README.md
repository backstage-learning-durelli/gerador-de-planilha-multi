# gerador-de-planilha-multi

Projeto FastAPI criado com Backstage, incluindo CI/CD e deploy automático via ArgoCD.

[![CI/CD](https://github.com/backstage-learning-durelli/gerador-de-planilha-multi/actions/workflows/ci-cd.yaml/badge.svg)](https://github.com/backstage-learning-durelli/gerador-de-planilha-multi/actions/workflows/ci-cd.yaml)
...
{
  "status": "healthy",
  "service": "gerador-de-planilha-multi",
  "version": "1.0.0"
}
```
...
```json
{
  "message": "Hello from gerador-de-planilha-multi!"
}
```
...
```bash
# Build da imagem
docker build -t gerador-de-planilha-multi:latest .

# Executar container
docker run -p 8000:8000 gerador-de-planilha-multi:latest
...
4. ✅ Publica no Docker Hub (`durellirsd/gerador-de-planilha-multi`)
...
- **Application**: `gerador-de-planilha-multi`
- **Namespace**: `gerador-de-planilha-multi`
- **Sync Policy**: Automático (prune + self-heal)

**Acessar no ArgoCD:**
```bash
# Via CLI
argocd app get gerador-de-planilha-multi
argocd app sync gerador-de-planilha-multi

# Ver logs
kubectl logs -n gerador-de-planilha-multi -l app=gerador-de-planilha-multi -f
```
...
kubectl get all -n gerador-de-planilha-multi

# Acessar a aplicação (port-forward)
kubectl port-forward -n gerador-de-planilha-multi svc/gerador-de-planilha-multi 8000:80
